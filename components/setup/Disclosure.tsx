...
export function Disclosure() {
  return (
    <aside className={styles.disclosure} aria-label="Transparência sobre links externos">
      <p>Links afiliados podem gerar comissão, sem custo adicional. Há {affiliateProducts.length} fichas com links afiliados; preço e estoque não foram verificados. As demais fichas são ilustrativas.</p>
