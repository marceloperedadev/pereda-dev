...
export function Disclosure() {
  return (
    <aside className={styles.disclosure} aria-label="Transparência sobre links externos">
      <p>Links afiliados podem gerar comissão, sem custo adicional. As ofertas do Redragon Fizz e do monitor 100 Hz não têm preço nem estoque verificados; as demais fichas são ilustrativas.</p>
