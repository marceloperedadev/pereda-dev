/**
 * Conteúdo editorial da Home e das páginas institucionais.
 *
 * Regra:
 * este arquivo concentra somente conteúdo.
 * Dados de contato, domínio e identidade técnica
 * devem permanecer centralizados em siteConfig.
 */
...
export const stack = {
  title:
    "Tecnologia quando ela precisa resolver alguma coisa.",

  lead:
    "Escolho ferramentas pelo que o projeto pede, não pelo que está na moda.",
